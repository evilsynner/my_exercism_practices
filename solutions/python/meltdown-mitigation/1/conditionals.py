...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    match percentage:
        case _ if percentage >= 80:
            return "green"
        case _ if percentage < 80 and percentage >= 60:
            return "orange"
        case _ if percentage < 60 and percentage >= 30:
            return "red"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    ninety_percent_threshold = threshold * 0.9
    ten_percent_threshold = threshold * 0.1
    result = temperature * neutrons_produced_per_second

    match result:
        case _ if result < ninety_percent_threshold:
            return "LOW"
        case _ if result >= (threshold - ten_percent_threshold) and \
                    result <= (threshold + ten_percent_threshold):
            return "NORMAL"
        case _:
            return "DANGER"
